                          ...
                          <tbody>
                            @foreach ($providers as $provider)
                              <tr id="fila{{$provider->id}}">
                                ...
                                <td class="center-text-column" id="estatus{{$provider->id}}">@if($provider->estado == 1) Habilidado @else Deshabilitado @endif</td> 
                                ...
                                <td class="table-button-center">
                                  <a class="btn boton-editar openModalEdit" data-id="{{$provider->id}}" data-name="{{$provider->nombreEmpresa}}"><i class="fa fa-edit fa-lg"></i></a>
                                  <a class="btn boton-deshabilitar" id="btn-des{{$provider->id}}" onclick="cambiarEstatusProveedor({{$provider->id}})"> @if($provider->estado == 1) <i class="fa fa-eye-slash fa-lg" aria-hidden="true"></i>@else <i class="fa fa-eye fa-lg" aria-hidden="true"></i> @endif </a>
                                  <a class="btn boton-eliminar" onclick="eliminarProveedor({{$provider->id}})"><i class="fa fa-trash fa-lg"></i></a>
                                </td>
                              </tr>
                            @endforeach
                          </tbody>
