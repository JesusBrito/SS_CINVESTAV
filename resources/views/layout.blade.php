      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="display: all;">
            <li class="active"><a href="{{route('usuarios.create')}}"><i class="fa fa-circle-o"></i>Registro de Nuevo Usuario</a></li>  
            <li><a href="{{route('usuarios.index')}}"><i class="fa fa-circle-o"></i>Listado de Usuarios</a></li>
